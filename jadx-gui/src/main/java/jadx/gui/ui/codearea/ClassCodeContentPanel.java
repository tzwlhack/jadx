...
public final class ClassCodeContentPanel extends AbstractCodeContentPanel implements IViewStateSupport {
	...
	private void initView() {
		...
		if (splitView) {
			...
			add(splitPane);
			splitPane.setLeftComponent(areaTabbedPane);
			splitPane.setRightComponent(splitPaneView);
	...
	private JTabbedPane buildTabbedPane(JClass jCls, boolean splitView) {
	...
	private void addCustomControls(JTabbedPane tabbedPane) {
		...
		splitCheckBox.addItemListener(e -> {
			...
			execInBackground(this::initView);
		});
